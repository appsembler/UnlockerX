...
"""
unlockerx documentation build configuration file.
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'An app to manage (and remove) password and IP-based locks.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'unlockerx'),
                os.path.join(root_path, 'unlockerx/migrations')])
